...
export const Canvas = ({ boardId }: CanvasProps) => {
    ...
    const resizedSelectedLayer = useMutation(({ storage, self }, point: Point) => {
    ...
    }, [canvasState, resizedSelectedLayer, camera, translateselectedLayers, startMultiSelection, updateSelectionNet, continueDrawing]);
